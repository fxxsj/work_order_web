<template>
  <div class="dispatch-preview p-5">
    <Alert
          ...
          >
            ...
            >
              <td class="text-center">
                <Icon
                  :name="expandedRows.has(idx) ? 'chevronDown' : 'chevronRight'"
            ...
            <tr v-if="expandedRows.has(idx)">
              <td
                colspan="6"
                class="bg-gray-50 dark:bg-dark-800 px-8 py-4"
              >
                <div v-if="row.all_departments && row.all_departments.length > 0">
                  ...
                  <table class="data-table w-full mt-2">
                    ...
                    <tbody>
                      <tr
                        v-for="dept in row.all_departments"
                      ...
                      >
                        <td>
                          <div class="flex items-center gap-2">
                            ...
                            <Tag
                              v-if="dept.department_id === row.target_department_id"
                              size="small"
                              type="success"
                            >
                              当前选择
                        ...
                        <td>
                          <ProgressBar
                            :percentage="dept.current_load || 0"
                            :status="getLoadStatus(dept.current_load)"
                          />
                        </td>
            ...
            >
              <div class="space-y-3">
                <div
                  v-for="i in 3"
                  :key="i"
                  class="h-6 animate-pulse rounded bg-gray-200 dark:bg-dark-600"
                />
              </div>
            </td>
          </tr>
...
const getWaitTimeClass = (waitTime: any) => {
  ...
  if (hours < 1) return 'text-success-500'
  if (hours < 4) return 'text-warning-500'
