<template>
  <div class="p-5">
    ...
    <div v-if="type === 'table'" class="space-y-4">
      <div v-for="i in rows" :key="i" class="flex animate-pulse">
        <div
          v-for="j in columns"
          :key="j"
    ...
    <div v-else-if="type === 'card'" class="space-y-4">
      <div v-for="i in rows" :key="i" class="card p-5 animate-pulse">
        <div class="skeleton h-28 w-full rounded-xl mb-4"></div>
        <div class="space-y-2">
          <div class="skeleton h-4 rounded" style="width: 60%"></div>
