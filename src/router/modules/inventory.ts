...
export const inventoryRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { title: '新建送货单', requiresAuth: true, requiresPermission: ['workorder.add_deliveryorder'] }
  },
  {
    path: 'inventory/delivery/:id/edit',
    name: 'DeliveryEdit',
    component: DeliveryForm,
    meta: { title: '编辑送货单', requiresAuth: true, requiresPermission: ['workorder.change_deliveryorder'] }
  },
  {
