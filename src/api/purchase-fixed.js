// Fixed: Purchase API - v3 - Force webpack recompile - Terminal fix
...
/**
 * 获取物料列表（用于采购单创建）
 * Fixed: v3 - Async function with console logging
 */
export async function getMaterialList(params) {
  console.log('[Purchase API v3] getMaterialList called with params:', params)
  const result = await service({
    url: '/materials/',
    method: 'get',
    params
  })
  console.log('[Purchase API v3] getMaterialList result:', result)
  return result
}
