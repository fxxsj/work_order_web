  ...
  <div v-loading="loading" class="task-section">
    <div class="task-stats">
      <el-row :gutter="20" align="middle">
        <el-col :span="5"><div class="stat-item"><div class="stat-value">{{ taskStats.total }}</div><div class="stat-label">全部任务</div></div></el-col>
        <el-col :span="5"><div class="stat-item draft"><div class="stat-value">{{ taskStats.draft }}</div><div class="stat-label">草稿</div></div></el-col>
        <el-col :span="5"><div class="stat-item pending"><div class="stat-value">{{ taskStats.pending }}</div><div class="stat-label">待处理</div></div></el-col>
        <el-col :span="5"><div class="stat-item completed"><div class="stat-value">{{ taskStats.completed }}</div><div class="stat-label">已完成</div></div></el-col>
        <el-col :span="4"><div class="progress-display"><div class="progress-label">完成进度</div><el-progress type="circle" :percentage="taskStats.progress || 0" :width="60" /></div></el-col>
      </el-row>
    </div>
