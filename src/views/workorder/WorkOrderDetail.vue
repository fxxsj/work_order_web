...
const showApprovalSection = computed(() => canApprove.value || canResubmit.value || workOrder.value?.approval_logs?.length || ['draft', 'pending', 'submitted', 'rejected', 'approved'].includes(workOrder.value?.approval_status))
