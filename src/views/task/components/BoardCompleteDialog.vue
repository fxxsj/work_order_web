  ...
  <BaseDialog :show="dialogVisible" title="完成任务" width="normal" @close="handleClose; dialogVisible = false;">
    <div class="space-y-4">
      ...
      <div>
        ...
        <InputNumber v-model="form.quantity_defective" :min="0" :max="form.quantity_completed" class="w-full sm:w-52" />
      </div>
      <TextArea v-model="form.notes" label="完成说明" :rows="3" placeholder="请输入完成说明（可选）" />
    </div>
    <template #footer>
