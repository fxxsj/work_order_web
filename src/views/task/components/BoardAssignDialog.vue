<template>
  <BaseDialog :show="dialogVisible" title="分派任务" width="narrow" @close="handleClose; dialogVisible = false;">
    <div class="space-y-4">
      ...
      <Select
        ...
        searchable
      />
      <TextArea v-model="form.notes" label="分派说明" :rows="3" placeholder="请输入分派说明（可选）" />
    </div>
    <template #footer>
