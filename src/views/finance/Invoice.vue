  ...
  <div class="invoice-container">
    ...
    <div class="header">
      ...
      <div class="actions">
        ...
        <el-button icon="el-icon-refresh" @click="fetchInvoiceList">刷新</el-button>
      </div>
    </div>
        ...
        <el-col :span="6">
          <el-card class="stat-card warning">
            <div class="stat-item">
              ...
              <div class="stat-value">¥{{ (stats.pending_amount || 0).toLocaleString() }}</div>
            </div>
          </el-card>
        </el-col>
        <el-col :span="6">
          <el-card class="stat-card success">
            <div class="stat-item">
              ...
              <div class="stat-value">¥{{ (stats.received_amount || 0).toLocaleString() }}</div>
            </div>
          </el-card>
        </el-col>
        <el-col :span="6">
      ...
      <el-form :inline="true" :model="filters" class="filter-form">
        <el-form-item label="发票状态">
          <el-select v-model="filters.status" placeholder="全部" clearable @change="handleSearch">
            <el-option label="待开具" value="draft"></el-option>
            <el-option label="已开具" value="issued"></el-option>
            <el-option label="已发送" value="sent"></el-option>
            <el-option label="已收到" value="received"></el-option>
    ...
    >
      <el-descriptions v-if="currentInvoice" :column="2" border>
        ...
        <el-descriptions-item label="关联单号" :span="2">{{ currentInvoice.related_order_number || '-' }}</el-descriptions-item>
    ...
    >
      <el-form :model="invoiceForm" :rules="invoiceRules" ref="invoiceFormRef" label-width="120px">
        <el-form-item label="客户" prop="customer">
          <el-select v-model="invoiceForm.customer" placeholder="请选择客户" filterable style="width: 100%;">
            <el-option
              v-for="customer in customerList"
              :key="customer.id"
              :label="customer.name"
        ...
        <el-form-item label="发票类型" prop="invoice_type">
          <el-select v-model="invoiceForm.invoice_type" placeholder="请选择发票类型" style="width: 100%;">
            <el-option label="增值税专用发票" value="vat_special"></el-option>
            <el-option label="增值税普通发票" value="vat_common"></el-option>
        ...
        <el-form-item label="税率" prop="tax_rate">
          <el-input-number v-model="invoiceForm.tax_rate" :min="0" :max="100" style="width: 100%;" />
        </el-form-item>
