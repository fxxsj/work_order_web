<template>
  <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑发货单' : '新建发货单'" width="900px" :close-on-click-modal="false" @close="handleClose">
    <el-form ref="formRef" :model="localForm" :rules="rules" label-width="100px">
      <h4 class="form-section-title">基本信息</h4>
      <el-row :gutter="20">
        <el-col :span="12"><el-form-item label="销售订单" prop="sales_order">
        ...
        <el-col :span="12"><el-form-item label="客户" prop="customer">
      ...
      <el-row :gutter="20">
        <el-col :span="12"><el-form-item label="收货人" prop="receiver_name"><el-input v-model="localForm.receiver_name" placeholder="请输入收货人" /></el-form-item></el-col>
        <el-col :span="12"><el-form-item label="联系电话" prop="receiver_phone"><el-input v-model="localForm.receiver_phone" placeholder="请输入联系电话" /></el-form-item></el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="12"><el-form-item label="发货日期" prop="delivery_date"><el-date-picker v-model="localForm.delivery_date" type="date" placeholder="请选择发货日期" value-format="YYYY-MM-DD" style="width: 100%" /></el-form-item></el-col>
        <el-col :span="12"><el-form-item label="物流公司"><el-select v-model="localForm.logistics_company" placeholder="请选择物流公司" filterable allow-create style="width: 100%">
      ...
      <el-row :gutter="20">
        <el-col :span="12"><el-form-item label="物流单号"><el-input v-model="localForm.tracking_number" placeholder="请输入物流单号" /></el-form-item></el-col>
        <el-col :span="12"><el-form-item label="运费（元）"><el-input-number v-model="localForm.freight" :precision="2" :min="0" style="width: 100%" /></el-form-item></el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12"><el-form-item label="包裹数量" prop="package_count"><el-input-number v-model="localForm.package_count" :min="1" style="width: 100%" /></el-form-item></el-col>
        <el-col :span="12"><el-form-item label="总重量(kg)"><el-input-number v-model="localForm.package_weight" :precision="2" :min="0" style="width: 100%" /></el-form-item></el-col>
      </el-row>

      <h4 class="form-section-title">发货明细<el-button type="primary" size="small" :icon="Plus" style="margin-left: 10px" @click="addItem">添加明细</el-button></h4>
      ...
      <el-form-item label="备注" style="margin-top: 20px"><el-input v-model="localForm.notes" type="textarea" :rows="3" placeholder="请输入备注信息" /></el-form-item>
    </el-form>
    <template #footer>
...
<style scoped>
.form-section-title { margin: 20px 0 15px 0; padding-bottom: 10px; border-bottom: 2px solid #409eff; color: #303133; font-size: 16px; font-weight: 500; display: flex; align-items: center; }
</style>
